                ...
                <div className="w-75 mx-auto my-4">
                    <Form onSubmit={handleForm}>
                        <div className="">
                            <div className="">
                                ...
                                <Form.Group as={Row} className="mb-3" controlId="formPlaintextAddress">
                                    ...
                                    <Col sm="10">
                                        <Form.Control as="textarea" rows={3} placeholder="Give your Address" name="address" onBlur={handleCommentOnBlur} />
                                    </Col>
                                </Form.Group>
                        ...
                        <div className="text-center">
                            <Button type="submit" variant="outline-danger">Save Review</Button>
                        </div>
