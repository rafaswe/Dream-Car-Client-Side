        ...
        <Container>
            {
                admin ? <div className="row row-cols-1 row-cols-md-3 g-4 h-100 pt-2">
                    <Link to="/manageAllOrder" className="text-decoration-none text-danger">
                        <div className="col ">
                    ...
                    <Link to="/addProduct" className="text-decoration-none text-danger ">
                        <div className="col">
                            <div className="card text-center  border border-0 bg-transparent custom-card-bg">
                    ...
                    <Link to="/manageAllProduct" className="text-decoration-none text-danger">
                        <div className="col ">
                    ...
                    <Link to="/makeAdmin" className="text-decoration-none text-danger">
                        <div className="col ">
                            <div className="card  text-center border border-0 bg-transparent custom-card-bg">
                    ...
                    <div className="row row-cols-1 row-cols-md-3 g-4">
                        <Link to="/myOrder" className="text-decoration-none text-danger">
                            <div className="col ">
                        ...
                        <Link to="/payBill" className="text-decoration-none text-danger ">
                            <div className="col">
                                <div className="card h-100 text-center py-4 border border-0 bg-transparent custom-card-bg">
                        ...
                        <Link to="/ratings" className="text-decoration-none text-danger">
                            <div className="col ">
                                <div className="card h-100 text-center py-4 border border-0 bg-transparent custom-card-bg">
