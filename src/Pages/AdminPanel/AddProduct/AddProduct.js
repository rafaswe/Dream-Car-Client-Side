...
const AddProduct = () => {
    ...
    const handleForm = (e) => {
        ...
        if (productName !== '' && productImg !== '' && productDescription !== '' && productPrice !== '') {
            axios.post('https://evening-shore-57198.herokuapp.com//addProduct', data)
                .then(res => {
    ...
    return (
        <Container className="my-5 p-4 ">
            ...
            <h1 className='text-center text-danger my-4'>Add New Product</h1>
            <hr className="mb-4" />
            ...
            <Form onSubmit={handleForm}>
                ...
                <div className="text-center mt-4">
                    <Button variant="outline-danger" type="submit">Add New Product</Button>
                </div>
