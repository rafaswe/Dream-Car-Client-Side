...
const ChooseReason = () => {
    ...
    return (
        <Container className="my-5">
            <h2 className="text-center text-danger mb-3">Why choose Us?</h2>
            <hr className="mb-5" />
            <div className="row gx-4">
                <div className="col-lg-3 col-sm-12">
                    <div className="row gx-0">
                        <div className="col-3">
                            <i className="fas fa-3x fa-tag text-danger"></i>
                        </div>
                        <div className="col-9">
                ...
                <div className="col-lg-3 col-sm-12">
                    <div className="row gx-0">
                        <div className="col-3">
                            <i className="fas fa-3x fa-bullseye text-danger"></i>
                        </div>
                        <div className="col-9">
                ...
                <div className="col-lg-3 col-sm-12">
                    <div className="row gx-0">
                        <div className="col-3">
                            <i className="far fa-3x fa-comments text-danger"></i>
                        </div>
                        <div className="col-9">
                ...
                <div className="col-lg-3 col-sm-12">
                    <div className="row gx-0">
                        <div className="col-3">
                            <i className="far fa-3x fa-list-alt text-danger"></i>
                        </div>
                        <div className="col-9">
