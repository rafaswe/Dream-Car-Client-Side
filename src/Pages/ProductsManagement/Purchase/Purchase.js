...
const Purchase = () => {
    ...
    // const initialInfo = { customerName: userInfo.displayName, email: user.email, phone: '' };
    ...
    return (
        <Container className="my-5 pt-4">
            ...
            <h1 className="mb-4 text-center text-danger">Purchase</h1>
            <hr className="mb-4" />
            <Container>
                <Form onSubmit={handleForm}>
                    ...
                    <div className="text-center">
                        <Button type="submit" variant="outline-danger">Place Order</Button>
                    </div>
