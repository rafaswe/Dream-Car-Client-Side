                ...
                <div className="row align-items-center">
                    ...
                    <div className="col-sm-12 col-lg-6">
                        <div className="text-center mb-4">
                            ...
                            <h2 className="text-white">DREAM CAR</h2>
                        </div>
                    ...
                    <div className="col-sm-12 col-lg-6 ps-5 text-center">
                        ...
                        <div className="address text-white">
                            ...
                            <div className="d-flex align-items-center justify-content-center"><span className="customized-text-color fs-3 me-2">{phone}</span> <span> 01635249785, 017596475321</span></div>
                            <div className="d-flex align-items-center justify-content-center"><span className="customized-text-color fs-3 me-2">{email}</span> <span> dreamcar@gmail.com</span></div>
                        </div>
                        <hr className="bg-light" />
                        <div className="useFullLinks text-center">
                            <a href="https://www.facebook.com/dreamcar" target="_blank" rel="noreferrer" className="mx-2 text-decoration-none text-white"> <i className="fab fa-2x fa-facebook-square"></i></a>
                            ...
                            <a href="mailto:dreamcar@gmail.com" target="_blank" rel="noreferrer" className="mx-2 text-decoration-none text-white"> <i className="fas fa-2x fa-envelope"></i></a>
                        </div>
                    </div>
                </div>
            </Container>
